...
public class Main
{
	public static void main(String[] args) throws Exception
	{
		...
		options.addOption("all", "Executes the entire pipeline after cleaning any persisted data.");
		options.addOption("clean", "Deletes persisted data.");
		options.addOption("importBillInfos", "Imports bill information.");
		options.addOption("importGpoUrls", "Imports the url of the plain text version of the bills.");
		options.addOption("importBills", "Imports a plain text version of the bills.");
		...
		options.addOption("partitionBills", "Partitions the bills for model and analysis.");
		options.addOption("createControversyScoreDatasets", "Creates the controversy score datasets.");
		options.addOption("countAnalysisForBills", "Displays count statistics for bills.");
		options.addOption("createModelDatasets", "Creates the dataset used by this model and SLDA");
