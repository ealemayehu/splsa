...
public class BillPersister
{
	...
	public static void saveData(int billId, String filename, String content) throws IOException
	{	
		assert (BILL_PERSISTENCE_DIRECTORY != null);
		Utility.saveData(BILL_PERSISTENCE_DIRECTORY + "/" + billId, filename, content);
	}
	...
	{
		File file = new File(BILL_PERSISTENCE_DIRECTORY + "/" + billId + "/" + filename);
	...
	public static void saveBillInfo(BillInfo billInfo) throws IOException,
	      JSONException
	{
		saveData(billInfo.getId(), "billInfo.json", billInfo.toJson().toString(INDENT_FACTOR));
	}
	...
	public static Map<String, Integer> getCountByFilteredWord(int billId) throws IOException
	{
	...
	public static void saveWords(int billId, String filename, Collection<String> words) throws IOException
	{
	...
	public static List<String> getWords(int billId, String filename) throws IOException
	{
	...
	public static void saveRawWords(int billId, Collection<String> words) throws IOException
	{
		saveWords(billId, "billRawWords.txt", words);
	}

	public static void saveFilteredWords(int billId, Collection<String> words) throws IOException
	{
	...
	public static Map<Integer, Integer> getBillNumberIdMap() throws IOException, JSONException
	{
	...
	public static Collection<BillInfo> getBillInfos() throws IOException,
	      JSONException
	{
		Collection<Integer> billIds = getBillIds();
	...
	public static BillInfo getBillInfo(int billId) throws IOException,
	      JSONException
	{
		return BillInfo
		      .fromJson(new JSONObject(getData(billId, "billInfo.json")));
	}
}
